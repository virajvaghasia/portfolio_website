    ...
    <dl className="grid gap-8 sm:grid-cols-2">
      {items.map((e) => (
        <div key={e.claim} className="flex flex-col">
          <dt className="order-2 mt-1 text-sm font-medium text-foreground break-words">{e.claim}</dt>
          <dd className="order-1 mono-figure text-3xl font-semibold break-words sm:text-4xl">{e.value}</dd>
